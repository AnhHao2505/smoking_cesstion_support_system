    ...
    try {
      ...
      if (existingLogData && existingLogData.data) {
        ...
        form.setFieldsValue({
          ...
          log_time: existingLogData.data.log_time
            ? moment(existingLogData.data.log_time)
            : moment(),
        });
        setEditMode(true);
      } else {
    ...
    try {
      ...
      const logData = {
        ...
        log_time: values.log_time
          ? values.log_time.format("HH:mm:ss")
        ...
        triggers_experienced: values.triggers_experienced
          ? values.triggers_experienced.join(",")
          : "",
        coping_strategies_used: values.coping_strategies_used
          ? values.coping_strategies_used.join(",")
          : "",
        notes: values.notes || "",
        overall_health: values.overall_health,
        withdrawal_symptoms: values.withdrawal_symptoms
          ? values.withdrawal_symptoms.join(",")
          : "",
            ...
            <Col xs={24} lg={16}>
              <Card
                title={
                  <Space>
                    ...
                    {existingLog
                      ? `Edit Log for ${selectedDate.format("DD/MM/YYYY")}`
                      : `Log for ${selectedDate.format("DD/MM/YYYY")}`}
                  </Space>
                }
                extra={
                  existingLog && (
              ...
              >
                ...
                >
                  ...
                  <Row gutter={[16, 16]}>
                    <Col xs={24} md={8}>
                      <Form.Item name="log_time" label="Log Time">
                    ...
                    <Col xs={24} md={8}>
                      <Form.Item
                        ...
                        rules={[
                          {
                            required: true,
                            message: "Please enter number of cigarettes",
                          },
                        ]}
                      >
                        <InputNumber
                    ...
                    <Col xs={24} md={8}>
                      <Form.Item
                        ...
                        rules={[
                          {
                            required: true,
                            message: "Please select your overall health",
                          },
                        ]}
                      >
                        <Select>
                  ...
                  <Row gutter={[16, 16]}>
                    ...
                    <Col xs={24} md={8}>
                      <Form.Item
                        ...
                        rules={[
                          { required: true, message: "Please rate your mood" },
                        ]}
                      >
                        <Slider
                          min={1}
                    ...
                    <Col xs={24} md={8}>
                      <Form.Item
                        ...
                        rules={[
                          {
                            required: true,
                            message: "Please rate your cravings",
                          },
                        ]}
                      >
                        <Slider
                  ...
                  <Row gutter={[16, 16]}>
                    <Col xs={24} md={8}>
                      <Form.Item
                        ...
                        rules={[
                          {
                            required: true,
                            message: "Please enter sleep hours",
                          },
                        ]}
                      >
                        <InputNumber
                    ...
                    <Col xs={24} md={8}>
                      <Form.Item name="sleep_quality" label="Sleep Quality">
                        <Select>
                          <Option value="excellent">Excellent</Option>
                          <Option value="good">Good</Option>
                          <Option value="fair">Fair</Option>
                    ...
                    <Col xs={24} md={12}>
                      ...
                      >
                        ...
                        >
                          ...
                          <Option value="social_situations">
                            Social Situations
                          </Option>
                    ...
                    <Col xs={24} md={12}>
                      ...
                      >
                        ...
                        >
                          ...
                          <Option value="support_call">
                            Called Support Person
                          </Option>
                          <Option value="nicotine_replacement">
                    ...
                    <Col xs={24} md={12}>
                      ...
                      >
                        ...
                        >
                          ...
                          <Option value="difficulty_concentrating">
                ...
                <Card title="Today's Summary" className="mb-4">
                  <Space direction="vertical" style={{ width: "100%" }}>
                    <div>
                      ...
                      <Tag
                        color={
                          existingLog.cigarettes_smoked === 0 ? "green" : "red"
                        }
                      >
                    ...
                    <div>
                      ...
                      <Progress
                        ...
                        strokeColor={getHealthColor(
                          10 - existingLog.craving_intensity
                        )}
                    ...
                    <div>
                      ...
                      <span>
                        {existingLog.sleep_hours} hours (
                        {existingLog.sleep_quality})
                      </span>
                    </div>
                  </Space>
                </Card>
