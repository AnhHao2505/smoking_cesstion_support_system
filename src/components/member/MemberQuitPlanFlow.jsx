...
const MemberQuitPlanFlow = () => {
  ...
  const fetchMemberQuitPlanData = async () => {
    try {
      ...
      // Check if we got valid plan data
      if (!currentPlanResponse || currentPlanResponse === null) {
        console.log("No plan data received for member:", memberId);
        setCurrentPlan(null);
        setPlanPhases([]);
        setPlanHistory([]);
        setLoading(false);
      ...
      const rawStatus = planData?.quitPlanStatus || planData?.status;
        ...
        {!currentPlan ? (
          ...
          <Card>
            <div className="text-center py-5">
              ...
              <Paragraph>
                Bạn chưa có kế hoạch cai thuốc nào. Huấn luyện viên được phân
                công sẽ tạo kế hoạch cá nhân hóa cho bạn trong thời gian sớm
                nhất.
              </Paragraph>
              <Paragraph type="secondary">
                Trong lúc chờ đợi, bạn có thể liên hệ với huấn luyện viên để
                  ...
                  <Alert
                    ...
                    description={
                      <div>
                        ...
                        <p>
                          Thời gian thực hiện:{" "}
                          <strong>{formatDate(currentPlan.start_date)}</strong>{" "}
                          đến{" "}
                      ...
                      <div>
                        ...
                        <div className="mt-3">
                          <Statistic
                            ...
                            suffix={`/ ${moment(currentPlan.end_date).diff(
                              moment(currentPlan.start_date),
                              "days"
                            )}`}
                          />
              ...
              <Card title="Thao tác nhanh">
                <Space direction="vertical" style={{ width: "100%" }}>
                  <Button
                    ...
                    icon={<CheckCircleOutlined />}
                    onClick={() =>
                      (window.location.href = "/member/daily-checkin")
                    }
                  >
                    Báo cáo hàng ngày
                  </Button>
                  ...
                  <Button
                    ...
                    icon={<TrophyOutlined />}
                    onClick={() =>
                      (window.location.href = "/member/progress-chart")
                    }
                  >
                    Xem tiến độ
                  </Button>
