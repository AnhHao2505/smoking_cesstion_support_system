...
const VideoCallPage = () => {
  ...
  const handleCallEnd = () => {
    ...
    if (window.opener && user?.RoleName.toLowerCase() === "member") {
      setShowRatingModal(true);
    } else if (window.opener && user?.RoleName.toLowerCase() === "consultant") {
      setShowCompletionModal(true);
    } else {
      navigate("/");
    }
            ...
            <div className="text-center mb-8">
              ...
              <p className="text-gray-600">
                ...
                {callData.isConsultant
                  ...
                  : callData.appointmentDetails.consultantName ||
                    "chuyên viên tư vấn"}
              </p>
            </div>
            ...
            <div className="bg-gray-50 rounded-lg p-6 mb-8">
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <p className="font-semibold">
                    {parseSqlDate(callData.appointmentDetails.date)}
                  </p>
                </div>
                <div>
                  <p className="text-sm text-gray-600">Thời gian</p>
                  <p className="font-semibold">
                    {parseISODateTime(callData.appointmentDetails.time)}
                  </p>
                </div>
              </div>
            </div>
