...
/**
 * Daily Checkin Service - Độc lập cho trang daily-checkin
 * Chỉ xử lý đánh giá mức độ nghiện thuốc và thống kê cơ bản
 */
...
// Lấy đánh giá nghiện thuốc mới nhất (chỉ cho daily checkin)
...
// Lấy thống kê cơ bản cho daily checkin (độc lập)
export const getBasicProgress = async (memberId) => {
  try {
    // Chỉ lấy thông tin cơ bản cần thiết cho daily checkin
    ...
    // Tính toán độc lập cho daily checkin
