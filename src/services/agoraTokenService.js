  ...
  async getDefaultVideoCallToken(channelName = null, userId = null) {
    try {
      ...
      const fallbackChannelName =
        channelName || this.DEFAULT_CONFIG.channelName;
      const fallbackUserId = userId || `user_${Date.now()}`;
      return this.getTempTokenConfig(fallbackChannelName, fallbackUserId);
    }
  },
